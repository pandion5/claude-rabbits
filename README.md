...
| 2 | 편성 | 아키타입 100종(코어 8 + 확장 92, 분야별 지연 로드) + 전문 팀 프리셋 5종(테크·법무·보안·서치·QA) + 모델·제한시간 배정 |
...
**확장 92종** — 12개 분야로 `skills/run/archetypes-ext/`에 상비, 대장이 서브작업에
...
│   ├── archetypes-ext/   # 확장 아키타입 92종 (12분야, 지연 로드)
